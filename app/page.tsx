...
const CATEGORIES = [
  "سلامت و تندرستی (ورزش، تغذیه، خواب، سلامت روان)",
  "اقتصاد و سواد مالی (درآمد، پس‌انداز، سرمایه‌گذاری، بدهی)",
  "زندگی روزمره و محیط (خانه، محل زندگی، نظم و سازمان)",
  "خانواده (رابطه با والدین، خواهر و برادر، خویشاوندان)",
  "ازدواج و همسر (انتخاب همسر، صمیمیت، زندگی مشترک، حل تعارض)",
  "روابط اجتماعی (دوستی، شبکه‌سازی، مهارت‌های مکالمه)",
  "شغل و حرفه (مسیر شغلی، تیم‌سازی، رهبری، ارتباط با دانشجو/مشتری)",
  "خودشناسی و هویت (ارزش‌ها، باورهای بنیادین، نقاط قوت و ضعف)",
  "هوش هیجانی و احساسات (شناخت احساسات، مدیریت خشم/اضطراب، همدلی)",
  "ذهنیت و الگوهای فکری (ترس‌ها، طرز فکر، تفکر انتقادی، باورهای محدودکننده)",
  "تصمیم‌گیری و حل مسئله (انتخاب، اولویت‌بندی، ریسک‌پذیری)",
  "عادت‌ها و خودانضباطی (ساختن عادت خوب، ترک عادت بد، مدیریت زمان)",
  "اخلاق و ارزش‌ها (درست و غلط، مسئولیت‌پذیری، عدالت، صداقت)",
  "سیاست و جامعه (درک سیاست، نقش شهروندی، آگاهی اجتماعی)",
  "فرهنگ و هنر (موسیقی، فیلم، ادبیات، تاثیر فرهنگ بر زندگی)",
  "تکنولوژی و آینده (هوش مصنوعی، تغییرات دنیا، استقلال دیجیتال)",
  "مهاجرت (دلایل، چالش‌ها، سازگاری، هویت در کشور جدید)",
  "تعادل بین زندگی (کار و زندگی، مسئولیت‌ها و استراحت)",
  "اعتماد به نفس (خودباوری، پذیرش خود، مقابله با ناامیدی)",
  "مرزها (نه گفتن، حفظ حریم شخصی، مدیریت انتظارات دیگران)",
  "صمیمیت (ارتباط عمیق، آسیب‌پذیری، اعتماد)",
  "شناخت انسان‌ها (تایپ‌های شخصیتی، انگیزه‌ها، رفتارشناسی)",
];
